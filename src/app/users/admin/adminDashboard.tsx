          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-5">
              <Link
                ...
                className="flex flex-col items-center justify-center p-4 bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-200/50 rounded-2xl transition-all duration-200 hover:-translate-y-0.5 text-center font-sans font-bold text-xs leading-normal tracking-normal cursor-pointer"
              >
                Create Event
              </Link>
              ...
              <button
                onClick={triggerStrikeProcessor}
                disabled={isProcessingStrikes}
                className="flex flex-col items-center justify-center p-4 bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-200/50 rounded-2xl transition-all duration-200 hover:-translate-y-0.5 text-center font-sans font-bold text-xs leading-normal tracking-normal cursor-pointer disabled:opacity-60"
              >
